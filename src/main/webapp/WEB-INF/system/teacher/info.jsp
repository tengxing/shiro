...
<%-- <script type="text/javascript" src="${pageContext.request.contextPath}/js/system/student/list.js"></script> --%>
    ...
    columns:[[
		...
		{field:'major',title:'主讲',width:200},
		{field:'age',title:'年龄',width:200},
		{field:'teachAge',title:'教龄',width:200},
		{field:'freeTime',title:'业余时间',width:200},
		{field:'status',title:'状态',width:200, sortable:true,formatter : function(value, row, index) {
       	 switch (value) {
         case 0:
             return '任课中';
         case 1:
