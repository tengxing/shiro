...
<link rel="stylesheet" type="text/css" href="${ctx}/notebook/notebook_files/app.v1.css"/>
...
<body>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control"
						placeholder="请输入姓名" name="username" id="userName">
				</div>
			</div>
		...
		<div class="line line-dashed line-lg pull-in"></div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control checkacc"
						placeholder="请输入手机号没又可不填" name="phone" id="accountName">
				</div>
